...
def benchmark_one_step(sess,
                       ...
                       should_output_files=True, tgs_trainer: Trainer=None):
  ...
  tgs_trainer.record(train_time)
  # print(f'step:{step}\ttrain time: {train_time}')
...
class BenchmarkCNN(object):
  ...
  def __init__(self, params, dataset=None, model=None):
    ...
    self._tgs_trainer = Trainer(worker_ip, worker_port, utils.get_host_ip(), trainer_port, job_id, params.batch_size)
    ...
    while not done_fn():
      ...
      (summary_str, last_average_loss) = benchmark_one_step(
          ...
          should_output_files=(self.params.variable_update != 'horovod' or
                               is_chief), tgs_trainer=self._tgs_trainer)
