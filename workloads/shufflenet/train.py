...
class Train:
    ...
    def train(self, tgs_trainer_instance):
        last_timestamp = time.time()
        for cur_epoch in range(self.model.global_epoch_tensor.eval(self.sess) + 1, self.model.global_epoch_tensor.eval(self.sess) + self.args.num_epochs + 1, 1):
            ...
            for X_batch, y_batch in tqdm_batch:
                ...
                timestamp = time.time()
                tgs_trainer_instance.record(timestamp - last_timestamp)
