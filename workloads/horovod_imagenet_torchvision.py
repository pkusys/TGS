...
def train(epoch):
    ...
    last_timestamp = time.time() if hvd.rank() == 0 else None
...
if __name__ == '__main__':
    ...
    trainer = Trainer(args.scheduler_ip, args.scheduler_port, utils.get_host_ip(), args.trainer_port, args.job_id, args.batch_size) if hvd.rank() == 0 else None
